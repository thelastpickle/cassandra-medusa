...
_BACKUPSTATUSTYPE = _descriptor.EnumDescriptor(
  name='BackupStatusType',
  full_name='BackupStatusType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
BackupStatusType = enum_type_wrapper.EnumTypeWrapper(_BACKUPSTATUSTYPE)
IN_PROGRESS = 0
SUCCESS = 1
FAILED = 2
...
_BACKUPRESPONSE.fields_by_name['status'].enum_type = _BACKUPSTATUSTYPE
...
DESCRIPTOR.enum_types_by_name['BackupStatusType'] = _BACKUPSTATUSTYPE

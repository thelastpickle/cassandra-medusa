...
import medusa.storage.minio_s3_storage.concurrent
from medusa.storage.minio_s3_storage.awscli import AwsCli
...
class MinIOStorage(S3Storage):
    ...
    def connect_storage(self):
        if self.config.key_file and os.path.exists(os.path.expanduser(self.config.key_file)):
            ...
            logging.debug("Reading MinIO credentials from Environment Variables.")
